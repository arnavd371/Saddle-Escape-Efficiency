...
Drop these next to the \texttt{.tex} if compiling the includes:
\texttt{results/figs1/fig1\_criteria\_grid.png},
\texttt{results/figs1/fig2\_spearman.png},
\texttt{results/figs1/fig3\_kendall\_w.png},
\texttt{results/figs2/rho\_ab\_vs\_dim.png},
\texttt{results/figs3/nn\_AB.png}.

\begin{figure}[ht]\centering
\includegraphics[width=\textwidth]{results/figs1/fig1_criteria_grid.png}
\caption{Best-LR SEE, all 2D functions $\times$ four criteria.}
\end{figure}

\begin{figure}[ht]\centering
\includegraphics[width=0.95\textwidth]{results/figs1/fig2_spearman.png}
\caption{Pairwise Spearman of best-LR SEE across criteria.}
\end{figure}

\begin{figure}[ht]\centering
\includegraphics[width=0.55\textwidth]{results/figs1/fig3_kendall_w.png}
\caption{Kendall's $W$ across A,B,C,D.}
\end{figure}

\begin{figure}[ht]\centering
\includegraphics[width=0.55\textwidth]{results/figs2/rho_ab_vs_dim.png}
\caption{Spearman $\rho(A,B)$ vs dimension (2D anchor from exp.~1).}
\end{figure}

\begin{figure}[ht]\centering
\includegraphics[width=0.55\textwidth]{results/figs3/nn_AB.png}
