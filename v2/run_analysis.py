...
kw = pd.read_csv('results/out1/kendall_w.csv').set_index('function')
...
sub.to_csv('results/out1/curvature_sharpness_input.csv')

print()
print('A-vs-B rank inversion across scales')
sp1 = pd.read_csv('results/out1/spearman.csv')
...
try:
    r2 = pd.read_csv('results/out2/rho_vs_dim.csv')
...
try:
    r3 = pd.read_csv('results/out3/rho_ab.csv')
...
best1 = pd.read_csv('results/out1/best_lr.csv')
...
print(pd.read_csv('results/out1/kendall_w.csv').to_string(index=False))
